...
public class Registration {
      ...
      ITEM_GROUPS.register(
          ...
          () ->
              CreativeTabRegistry.create(
                  Text.translatable("itemGroup.littlemaidrebirth.common"),
  ...
  public static final RegistrySupplier<Item> SALARY_BOX_BLOCK_ITEM =
      ITEMS.register(
          "salary_box",
          () -> new BlockItem(SALARY_BOX_BLOCK.get(), new Item.Settings().arch$tab(ITEM_GROUP)));

  // スクリーンハンドラ
  public static final RegistrySupplier<ScreenHandlerType<LittleMaidScreenHandler>>
      LITTLE_MAID_SCREEN_HANDLER =
          SCREEN_HANDLERS.register(
              "little_maid", () -> MenuRegistry.ofExtended(LittleMaidScreenHandler::new));
