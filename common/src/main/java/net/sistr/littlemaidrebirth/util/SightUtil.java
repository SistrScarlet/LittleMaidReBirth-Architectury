...
public class SightUtil {
  ...
  public static List<Entity> getInSightEntities(
      World world,
      Entity entity,
      Vec3d viewPos,
      Vec3d lookFor,
  ...
  public static boolean isInFrustum(
      Vec3d viewPos, Vec3d targetPos, Vec3d lookFor, float yawFov, float pitchFov) {
  ...
  public static float[] getYawPitch(Vec3d vec) {
    ...
    float lookAtPitch =
        (float) (-MathHelper.atan2(vec.y, lookAtHorizontal) * (180D / (float) Math.PI));
