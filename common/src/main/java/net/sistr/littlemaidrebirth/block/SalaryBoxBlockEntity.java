...
public class SalaryBoxBlockEntity extends LootableContainerBlockEntity {
    ...
    public static void tick(World world, BlockPos pos, BlockState state, SalaryBoxBlockEntity blockEntity) {
        ...
        var entityList = world.getEntitiesByClass(Entity.class, box,
                e -> e instanceof SalaryBoxPosListener
                        && isinNotifyRange(pos, e.getPos()));
