...
public class LittleMaidScreenHandler extends ScreenHandler
    ...
    public LittleMaidScreenHandler(
            int syncId, PlayerInventory playerInventory, PacketByteBuf packet) {
    ...
    private void layoutMaidInventorySlots() {
        ...
        // 20~23
        addSlot(
                new Slot(armorInventory, EquipmentSlot.HEAD.getEntitySlotId(), 8, 8) {
        ...
        addSlot(
                new Slot(armorInventory, EquipmentSlot.CHEST.getEntitySlotId(), 8, 44) {
                    @Override
                    public int getMaxItemCount() {
                        return 1;
                    }
        ...
        addSlot(
                new Slot(armorInventory, EquipmentSlot.LEGS.getEntitySlotId(), 80, 8) {
                    @Override
                    public int getMaxItemCount() {
                        return 1;
                    }
        ...
        addSlot(
                new Slot(armorInventory, EquipmentSlot.FEET.getEntitySlotId(), 80, 44) {
                    @Override
                    public int getMaxItemCount() {
                        return 1;
                    }
