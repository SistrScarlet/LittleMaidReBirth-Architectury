...
public class LittleMaidScreen extends HandledScreen<LittleMaidScreenHandler> {
    ...
    protected void init() {
        ...
        this.addDrawableChild(
                new IconButtonWidget(
                        ...
                        BOOK,
                        Text.translatable(
                                "gui.littlemaidrebirth.littlemaid.tooltip.open_target_tag_setting"),
        ...
        this.addDrawableChild(
                new IconButtonWidget(
                        ...
                        NOTE,
                        Text.translatable(
                                "gui.littlemaidrebirth.littlemaid.tooltip.open_sound_pack_select"),
        ...
        this.addDrawableChild(
                new IconButtonWidget(
                        ...
                        ARMOR,
                        Text.translatable(
                                "gui.littlemaidrebirth.littlemaid.tooltip.open_model_select"),
                        button ->
                                client.setScreen(
        ...
        this.addDrawableChild(
                new IconButtonWidget(
                        ...
                        FEATHER,
                        Text.translatable(
                                "gui.littlemaidrebirth.littlemaid.tooltip.change_moving_mode"),
                        button -> {
        ...
        this.addDrawableChild(
                new IconButtonWidget(
                    ...
                    private static final Text changeBloodSuck =
                            Text.translatable(
                                    "gui.littlemaidrebirth.littlemaid.tooltip.change_blood_suck");
                    private static final Text toBloodSuck =
                            changeBloodSuck
                                    .copy()
                                    .append(
                                            Text.translatable(
                                                    "gui.littlemaidrebirth.littlemaid.tooltip.change_blood_suck.to_blood_suck"));
                    private static final Text isBloodSuck =
                            changeBloodSuck
                                    .copy()
                                    .append(
                                            Text.translatable(
                                                    "gui.littlemaidrebirth.littlemaid.tooltip.change_blood_suck.is_blood_suck"));
        ...
        this.addDrawableChild(
                new IconButtonWidget(
                        ...
                        BOOK,
                        Text.translatable(
                                "gui.littlemaidrebirth.littlemaid.tooltip.open_maid_manager"),
        ...
        this.addDrawableChild(
                new IconButtonWidget(
                        ...
                        CHEST,
                        Text.translatable(
                                "gui.littlemaidrebirth.littlemaid.tooltip.setting_work_item_slot"),
    ...
    public Text getStateText() {
        ...
        MutableText stateText =
                Text.translatable("state." + LMRBMod.MODID + "." + movingMode.getName());
        owner.getModeName()
                .ifPresent(
                        modeName ->
                                stateText
    ...
    protected void drawForeground(DrawContext context, int mouseX, int mouseY) {
        ...
        String insideSkirt =
                Text.translatable("entity.littlemaidrebirth.little_maid_mob.InsideSkirt")
                        .getString();
        context.drawText(
                textRenderer,
                insideSkirt,
                168 - textRenderer.getWidth(insideSkirt),
                65,
                0x404040,
                false);
        float left = (width - backgroundWidth) / 2F;
