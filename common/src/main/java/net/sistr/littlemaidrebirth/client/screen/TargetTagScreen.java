    ...
    public static class TargetTagGUIElement extends GUIElement implements ListGUIElement {
        ...
        private enum AttackState {
            ...
            PREEMPTIVE_ATTACK_PROHIBITED(
                    "preemptive_attack_prohibited", Items.SHIELD.getDefaultStack()),
            PREEMPTIVE_ATTACK_ALLOWED(
                    "preemptive_attack_allowed", Items.IRON_SWORD.getDefaultStack());
        ...
        public TargetTagGUIElement(
            ...
            this.buttons.add(
                    new LittleMaidScreen.IconButtonWidget(
                            ...
                            Text.translatable(
                                    "gui.littlemaidrebirth.target_tag.tags."
                                            + this.attackState.translationKey),
            ...
            this.buttons.add(
                    new LittleMaidScreen.IconButtonWidget(
                            ...
                            Text.translatable(
                                    "gui.littlemaidrebirth.target_tag.tags."
                                            + this.weaponState.translationKey),
            ...
            this.buttons.add(
                    new LittleMaidScreen.IconButtonWidget(
                            ...
                            Text.translatable(
                                    "gui.littlemaidrebirth.target_tag.tags."
                                            + this.approachState.translationKey),
        ...
        private WeaponState determineWeaponState(Set<TargetingSystem.TargetTag> tags) {
            boolean meleeProhibited =
                    tags.contains(TargetingSystem.TargetTag.MELEE_WEAPON_PROHIBITED);
            boolean rangedProhibited =
                    tags.contains(TargetingSystem.TargetTag.RANGED_WEAPON_PROHIBITED);
        ...
        public Set<TargetingSystem.TargetTag> getTags() {
            ...
            // 武器状態から対応するタグを追加
            switch (weaponState) {
                case MELEE_WEAPON_PROHIBITED -> tags.add(
                        TargetingSystem.TargetTag.MELEE_WEAPON_PROHIBITED);
