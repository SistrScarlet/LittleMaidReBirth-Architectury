...
public class Networking {
  ...
  private void clientInit() {
    NetworkManager.registerReceiver(
        NetworkManager.Side.S2C, SyncSoundConfigPacket.ID, SyncSoundConfigPacket::receiveS2CPacket);
    NetworkManager.registerReceiver(
        NetworkManager.Side.S2C, SpawnLittleMaidPacket.ID, SpawnLittleMaidPacket::receiveS2CPacket);
    NetworkManager.registerReceiver(
  ...
  private void serverInit() {
    ...
    NetworkManager.registerReceiver(
        NetworkManager.Side.C2S, SyncSoundConfigPacket.ID, SyncSoundConfigPacket::receiveC2SPacket);
    NetworkManager.registerReceiver(
        NetworkManager.Side.C2S, C2SSetBloodSuckPacket.ID, C2SSetBloodSuckPacket::receiveC2SPacket);
    NetworkManager.registerReceiver(
        NetworkManager.Side.C2S,
