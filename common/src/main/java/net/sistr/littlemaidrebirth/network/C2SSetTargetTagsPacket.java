...
public class C2SSetTargetTagsPacket {
    public static final Identifier ID =
            new Identifier(LMRBMod.MODID, "set_target_tags");

    @Environment(EnvType.CLIENT)
    public static <T extends Entity & TargetTagManager> void sendC2SPacket(T entity, Map<TargetIdentifier, Set<TargetingSystem.TargetTag>> targetTags) {
