...
public class WorldMaidSoulState extends PersistentState {
    ...
    public static WorldMaidSoulState createFromNbt(
            NbtCompound nbt, RegistryWrapper.WrapperLookup lookup) {
    ...
    public static WorldMaidSoulState getWorldMaidSoulState(ServerWorld world) {
        ...
        return persistentStateManager.getOrCreate(
                new PersistentState.Type<>(
                        WorldMaidSoulState::new, WorldMaidSoulState::createFromNbt, null),
